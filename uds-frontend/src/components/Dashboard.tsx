...
export const Dashboard = () => {
  ...
  const stats = [
    { title: "Total Components", value: totalComponents.toString(), icon: Package, trend: `${components.length} types`, color: "primary" },
    { title: "Checked Out", value: checkedOutCount.toString(), icon: TrendingUp, trend: `${activeUsers} users`, color: "accent" },
    { title: "Low Stock", value: lowStockCount.toString(), icon: AlertCircle, trend: "Need reorder", color: "destructive" },
    { title: "Active Users", value: activeUsers.toString(), icon: Users, trend: "Currently borrowing", color: "primary" },
  ];
